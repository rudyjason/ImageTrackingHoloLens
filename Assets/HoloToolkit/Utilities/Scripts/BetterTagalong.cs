...
namespace HoloToolkit.Unity
{
    ...
    public class BetterTagalong : MonoBehaviour
    {
        ...
        public Camera TagAlongView;

        [Range(0.01f, 5.0f), Tooltip("The factor applied to the smoothing algorithm. 1.0f is super smooth. But slows things down a lot.")]
        ...
        protected virtual bool CalculateTagalongTargetPosition(Vector3 fromPosition, out Vector3 toPosition)
        {
            ...
            toPosition = TagAlongView.transform.position + TagAlongView.transform.forward * TagalongDistance;
            ...
            if (moveRight)
            {
                ...
                ray.direction = -TagAlongView.transform.right;
            }
            else if (moveLeft)
            {
            ...
            if (moveDown)
            {
                ...
                ray.direction = TagAlongView.transform.up;
            }
            else if (moveUp)
            {
            ...
            ray = new Ray(TagAlongView.transform.position, toPosition - TagAlongView.transform.position);
