...
namespace HoloToolkit.Unity
{
    ...
    public class CustomDirectionIndicator : MonoBehaviour
    {
        ...
        public CustomDirectionIndicator(GameObject cursor, GameObject directionIndicatorObject)
        {
            Cursor = cursor;
            DirectionIndicatorObject = directionIndicatorObject;
        }
        ...
        private GameObject InstantiateDirectionIndicator(GameObject directionIndicator)
        {
            ...
            Debug.Log("Indicator: " + indicator.name);
            indicator.tag = "pointer";
            Debug.Log("Indicator tag: " + indicator.tag);
